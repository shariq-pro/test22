...
import { faCancel, faCheck, faClose, faCopy, faCross, faLock, faMartiniGlassCitrus, faRightFromBracket, faSpinner } from "@fortawesome/free-solid-svg-icons";
  ...
  >
   ...
   <span className="wallet_heading"> <FontAwesomeIcon icon={faClose} onClick={props.onHide} className="wallet_close_icon"  /></span>
        ...
        <Row className="p-1 h-100" >
          ...
          <span className="disconnect_modal_img">🍊</span>
