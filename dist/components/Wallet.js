...
function Wallet() {
  ...
  var _useState3 = (0, _react.useState)(false),
    ...
    disconnectmodalShow = _useState4[0],
    setDisconnectmodalShow = _useState4[1];
  var _useState5 = (0, _react.useState)(false),
    _useState6 = _slicedToArray(_useState5, 2),
    connect_wallet_address = _useState6[0],
    set_connect_wallet_address = _useState6[1];
  var _useState7 = (0, _react.useState)(false),
    _useState8 = _slicedToArray(_useState7, 2),
    wallet_address = _useState8[0],
    get_connect_wallet_address = _useState8[1];
  ...
  function getCurrentWallet() {
    return _getCurrentWallet.apply(this, arguments);
  }
  function _getCurrentWallet() {
    _getCurrentWallet = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var check_disconnect, addressArray;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              check_disconnect = localStorage.getItem('check_disconnect');
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, connect_wallet_address ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactBootstrap.Button, {
    ...
    onClick: function onClick() {
      return setDisconnectmodalShow(true);
    }
    ...
    onHide: function onHide() {
      return setDisconnectmodalShow(false);
    },
